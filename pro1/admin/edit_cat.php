...
if(isset($_POST['update_cat']))
{
    ...
    if($update_cat)
    {
        header("location: index.php?view_categories.php");
    }
}
?>
<div class="row">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="text" id="cat_title" name="cat_title" placeholder="Title" value="<?php echo $cat_title;?>">
                </div>
            </div>
            <div class="form-group row">
